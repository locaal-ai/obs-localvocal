...
std::string ClaudeTranslator::getLanguageName(const std::string &lang_code) const
{
...
bool ClaudeTranslator::isLanguageSupported(const std::string &lang_code) const
{
